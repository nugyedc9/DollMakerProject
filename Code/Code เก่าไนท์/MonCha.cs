...
public class MonCha : MonoBehaviour
{
    ...
    public Animator ani;
    AudioSource monsound;
    public AudioClip MonShootSound;
    ...
    private void Awake()
    {
        ...
        monsound = GetComponent<AudioSource>();
    }
    ...
    private void DestroyEnemy()
    {
        ...
        monsound.PlayOneShot(MondeadSound);
        Destroy(gameObject);
        DropMana();
    }
